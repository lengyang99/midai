...
class EditorAddress extends Component {
    ...
    submitAddress = (e) => {
        e.preventDefault()
        const {provinceId, cityId, province, city} = this.state
        ...
        NetUtils.fetchRequest('/api/h5/rest/ADD_USER_ADDRESS',params).then(res => {
                    ...
                    <form onSubmit={(e) => { this.submitAddress(e) }}>
                        <div className={'info-wrap'}>
                            <div className={'input-wrap'}>
                                ...
                                <input type="text" ref="name" onFocus={this.shuru} className={'input'} placeholder="请输入收货人真实姓名" />
                            </div>
...
const EditorAddressWrap = createForm()(EditorAddress)
export default EditorAddressWrap